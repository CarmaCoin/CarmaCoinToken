/**
   ...
   #Welcome to the World of CarmaCoin, VROOM VROOM
   #Features:
   #10% transaction fee
   #5% to stakeholders
   #5% to liquidity
   #Ability to update router address
...
contract CarmaCoin is Context, IERC20, Ownable {
    ...
    string private _name = "CarmaCoin";
    string private _symbol = "CARMA";
